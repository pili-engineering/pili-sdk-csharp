...
namespace Qiniu.Pili.Internal
{
    ...
    internal static class Base64UrlEncoder
    {
        ...
        /// <param name="padding">Add padding characters at the end of the encoded string if needed.</param>
        ...
        public static string Encode(byte[] inArray, int offset, int length, bool padding = true)
        {
            if (inArray == null)
            {
            ...
            var encoded = Convert.ToBase64String(inArray, offset, length)
        ...
        /// <exception cref="T:System.ArgumentNullException">'inArray' is null.</exception>
        /// <exception cref="T:System.ArgumentOutOfRangeException">offset or length is negative OR offset plus length is greater than the length of inArray.</exception>
        public static string Encode(byte[] inArray, bool padding = true)
        {
            return Encode(inArray, 0, inArray.Length, padding);
        }
        ...
        private static string Pad(string str)
        {
            switch (str.Length % 4)
            {
                ...
                default:
                    throw new FormatException($"IDX14700: Unable to decode: '{str}' as Base64url encoded string.");
            }
        }
    }
}
